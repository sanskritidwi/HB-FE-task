        ...
        <>
            <div className='footer'>
                <div className='h-con' style={{ display: 'flex' }}>
                   <div > <a href='https://drive.google.com/file/d/1MR7UBEyEgcDzmLKPPkvbAgl0hV1b-0zQ/view?usp=sharing' target="_blank" style={{display:'flex',alignItems:'center', marginRight:'50px'}}>
